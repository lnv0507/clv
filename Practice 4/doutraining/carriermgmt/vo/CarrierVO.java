...
public class CarrierVO extends AbstractValueObject {
	...
	public CarrierVO(String ibflag, String pagerows, String joCrrCd,
			String rlaneCd, String vndrSeq, String custCntCd, String custSeq,
			String trdCd, String deltFlg, String creDt, String creUsrId,
			String updDt, String updUsrId) {
		this.updDt = updDt;
	...
	public CarrierVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		...
		try {
			String[] updDt = (JSPUtil.getParameter(request, prefix + "upd_dt",
					length));
			String[] deltFlg = (JSPUtil.getParameter(request, prefix
					+ "delt_flg", length));
			...
			String[] creUsrId = (JSPUtil.getParameter(request, prefix
					+ "cre_usr_id", length));
			String[] vndrSeq = (JSPUtil.getParameter(request, prefix
					+ "vndr_seq", length));
	...
	public CarrierVO[] getCarrierVOs() {
		CarrierVO[] vos = (CarrierVO[]) models.toArray(new CarrierVO[models
				.size()]);
		return vos;
	}
	...
	public void unDataFormat() {
		...
		this.deltFlg = this.deltFlg.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		...
		this.creUsrId = this.creUsrId.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.vndrSeq = this.vndrSeq.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
