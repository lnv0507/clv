...
*@FileName : InvoiceDBDAOInvoiceTrade.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class InvoiceDBDAOInvoiceTrade implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public InvoiceDBDAOInvoiceTrade(){
		setQuery();
		...
		query.append("FileName : InvoiceDBDAOInvoiceTrade").append("\n"); 
		query.append("*/").append("\n"); 
	}
