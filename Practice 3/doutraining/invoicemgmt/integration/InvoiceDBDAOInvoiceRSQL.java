 ...
 *@FileName : InvoiceDBDAOInvoiceRSQL.java
 *@FileTitle : 
 *Open Issues :
 *Change history :
...
public class InvoiceDBDAOInvoiceRSQL implements ISQLTemplate {
	 ...
	 * </pre>
	 */
	public InvoiceDBDAOInvoiceRSQL() {
		setQuery();
		...
		query.append(
				...
				.append("\n");
		query.append("FileName : InvoiceDBDAOInvoiceRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery() {
		...
		query.append("                 ( SELECT M.CUST_LGL_ENG_NM")
				.append("\n");
		query.append("                     FROM MDM_CUSTOMER M").append("\n");
		query.append("                     WHERE M.DELT_FLG = 'N'")
				.append("\n");
		query.append(
		...
		query.append("                 ( SELECT M.VNDR_LGL_ENG_NM")
				.append("\n");
		query.append("                     FROM MDM_VENDOR M").append("\n");
		query.append("                    WHERE M.DELT_FLG = 'N'").append("\n");
		query.append("                      AND M.VNDR_SEQ = INV.PRNR_REF_NO )")
				.append("\n");
		...
		query.append("").append("\n");
		query.append(
				" GROUP BY GROUPING SETS ((JO_CRR_CD, RLANE_CD, CSR_NO, APRO_FLG, CUST_VNDR_CNT_CD, CUST_VNDR_SEQ, PRNR_REF_NO, CUST_VNDR_ENG_NM, LOCL_CURR_CD, INV_NO),")
				.append("\n");
