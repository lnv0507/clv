 ...
 *@FileName : InvoiceDBDAOInvoiceDetailRSQL.java
 *@FileTitle : 
 *Open Issues :
 *Change history :
...
public class InvoiceDBDAOInvoiceDetailRSQL implements ISQLTemplate {
	 ...
	 * </pre>
	 */
	public InvoiceDBDAOInvoiceDetailRSQL() {
		setQuery();
		...
		query.append(
				...
				.append("\n");
		query.append("FileName : InvoiceDBDAOInvoiceDetailRSQL").append("\n");
		query.append("*/").append("\n");
	}
	...
	public void setQuery() {
		...
		query.append("	,NVL(INV.INV_CURR_CD, INV.LOCL_CURR_CD) AS LOCL_CURR_CD")
				.append("\n");
		...
		query.append("		 AND M.CUST_CNT_CD =SUBSTR(INV.PRNR_REF_NO,1,2)")
				.append("\n");
		...
		query.append(
				...
				.append("\n");
		query.append("	 #if (${jo_crr_cds}!=''  && ${jo_crr_cds} != 'ALL')")
				.append("\n");
		query.append(
		...
		query.append("						   AND CRR.JO_CRR_CD        = STL.JO_CRR_CD")
				.append("\n");
		query.append("						   AND CRR.RLANE_CD         = STL.RLANE_CD")
				.append("\n");
		...
		query.append("    AND STL.STL_VVD_SEQ   = DTL.STL_VVD_SEQ")
				.append("\n");
		...
		query.append("WHERE 1=1").append("\n");
		query.append(
				"GROUP BY GROUPING SETS ((JO_CRR_CD, RLANE_CD, CSR_NO, APRO_FLG, CUST_VNDR_CNT_CD, CUST_VNDR_SEQ, PRNR_REF_NO, CUST_VNDR_ENG_NM, LOCL_CURR_CD, INV_NO, RE_DIVR_CD, JO_STL_ITM_CD),")
				.append("\n");
