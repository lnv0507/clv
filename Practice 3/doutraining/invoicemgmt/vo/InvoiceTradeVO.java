...
public class InvoiceTradeVO extends AbstractValueObject {
	...
	public InvoiceTradeVO(String ibflag, String pagerows, String trdCd, String toAcctYrmon, String frAcctYrmon) {
		this.ibflag = ibflag;
		this.trdCd = trdCd;
...
/**
	 ...
	 * @return TradeVO[]
	 */
	public InvoiceTradeVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
	...
	public InvoiceTradeVO[] getInvoiceTradeVOs(){
		InvoiceTradeVO[] vos = (InvoiceTradeVO[])models.toArray(new InvoiceTradeVO[models.size()]);
		return vos;
	}
