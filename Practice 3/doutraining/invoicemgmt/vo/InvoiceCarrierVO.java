...
public class InvoiceCarrierVO extends AbstractValueObject {
	...
	public InvoiceCarrierVO(String ibflag, String pagerows, String trdCd, String rlaneCd, String joCrrCd) {
		this.ibflag = ibflag;
...
/**
	 ...
	 * @return InvoiceCarrierVO[]
	 */
	public InvoiceCarrierVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
	...
	public InvoiceCarrierVO[] getInvoiceCarrierVOs(){
		InvoiceCarrierVO[] vos = (InvoiceCarrierVO[])models.toArray(new InvoiceCarrierVO[models.size()]);
		return vos;
	}
