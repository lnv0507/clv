...
public class InvoiceVO extends AbstractValueObject {
	...
	public InvoiceVO(String ibflag, String pagerows, String joCrrCd,
			...
			String invExpActAmt, String acctYrmonFr, String acctYrmonTo,
			String trdCd) {
		this.csrNo = csrNo;
	...
	public InvoiceVO[] getInvoiceVOs() {
		InvoiceVO[] vos = (InvoiceVO[]) models.toArray(new InvoiceVO[models
				.size()]);
		return vos;
	}
