package com.clt.apps.opus.dou.doutraining.codeerrgmgt.vo;
...
public class IntgCdVO extends AbstractValueObject {

	private static final long serialVersionUID = 1L;

	private Collection<IntgCdVO> models = new ArrayList<IntgCdVO>();
	...
	public IntgCdVO(String ibflag, String pagerows, String ownrSubSysCd,
			String intgCdId, String intgCdNm, String intgCdLen,
			String intgCdTpCd, String mngTblNm, String intgCdDesc,
			String intgCdUseFlg, String creUsrId, String creDt,
	...
	public void fromRequest(HttpServletRequest request, String prefix) {
		...
		setIntgCdDesc(JSPUtil
				.getParameter(request, prefix + "intg_cd_desc", ""));
		setOwnrSubSysCd(JSPUtil.getParameter(request, prefix
				+ "ownr_sub_sys_cd", ""));
		...
		setIntgCdUseFlg(JSPUtil.getParameter(request, prefix
				+ "intg_cd_use_flg", ""));
	 ...
	 * @return MasterVO[]
	 */
	public IntgCdVO[] fromRequestGrid(HttpServletRequest request) {
	 ...
	 * @return MasterVO[]
	 */
	public IntgCdVO[] fromRequestGrid(HttpServletRequest request, String prefix) {
		IntgCdVO model = null;
		...
		try {
			String[] updDt = (JSPUtil.getParameter(request, prefix + "upd_dt",
					length));
			String[] intgCdLen = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_len", length));
			String[] intgCdDesc = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_desc", length));
			String[] ownrSubSysCd = (JSPUtil.getParameter(request, prefix
					+ "ownr_sub_sys_cd", length));
			String[] intgCdTpCd = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_tp_cd", length));
			String[] creDt = (JSPUtil.getParameter(request, prefix + "cre_dt",
					length));
			String[] mngTblNm = (JSPUtil.getParameter(request, prefix
					+ "mng_tbl_nm", length));
			String[] pagerows = (JSPUtil.getParameter(request, prefix
					+ "pagerows", length));
			String[] intgCdId = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_id", length));
			String[] ibflag = (JSPUtil.getParameter(request, prefix + "ibflag",
					length));
			String[] intgCdUseFlg = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_use_flg", length));
			String[] creUsrId = (JSPUtil.getParameter(request, prefix
					+ "cre_usr_id", length));
			String[] intgCdNm = (JSPUtil.getParameter(request, prefix
					+ "intg_cd_nm", length));
	...
	public IntgCdVO[] getIntgCdVOs() {
		IntgCdVO[] vos = (IntgCdVO[]) models
				.toArray(new IntgCdVO[models.size()]);
		return vos;
	}
	...
	public void unDataFormat() {
		...
		this.intgCdLen = this.intgCdLen.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.intgCdDesc = this.intgCdDesc.replaceAll(",", "")
				.replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.ownrSubSysCd = this.ownrSubSysCd.replaceAll(",", "")
				.replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.intgCdTpCd = this.intgCdTpCd.replaceAll(",", "")
				.replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.creDt = this.creDt.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.mngTblNm = this.mngTblNm.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.pagerows = this.pagerows.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.intgCdId = this.intgCdId.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.ibflag = this.ibflag.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.intgCdUseFlg = this.intgCdUseFlg.replaceAll(",", "")
				.replaceAll("-", "").replaceAll("/", "").replaceAll(":", "");
		this.creUsrId = this.creUsrId.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
		this.intgCdNm = this.intgCdNm.replaceAll(",", "").replaceAll("-", "")
				.replaceAll("/", "").replaceAll(":", "");
