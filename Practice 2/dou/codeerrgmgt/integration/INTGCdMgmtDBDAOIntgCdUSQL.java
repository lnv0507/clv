...
*@FileName : INTGCdMgmtDBDAOIntgCdUSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class INTGCdMgmtDBDAOIntgCdUSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public INTGCdMgmtDBDAOIntgCdUSQL(){
		setQuery();
		...
		query.append("FileName : INTGCdMgmtDBDAOIntgCdUSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
