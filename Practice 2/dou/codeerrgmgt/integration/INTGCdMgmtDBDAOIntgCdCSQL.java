...
*@FileName : INTGCdMgmtDBDAOIntgCdCSQL.java
*@FileTitle : 
*Open Issues :
*Change history :
...
public class INTGCdMgmtDBDAOIntgCdCSQL implements ISQLTemplate{
	...
	/**
	  ...
	  * </pre>
	  */
	public INTGCdMgmtDBDAOIntgCdCSQL(){
		setQuery();
		...
		query.append("FileName : INTGCdMgmtDBDAOIntgCdCSQL").append("\n"); 
		query.append("*/").append("\n"); 
	}
